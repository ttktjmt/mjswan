...
export function setupGUI(parentContext) {
  ...
  let reload = reloadScene.bind(parentContext);
  let taskFolder = parentContext.gui.addFolder("Task Selection"); // Create a new folder
  taskFolder.add(parentContext.params, 'scene', {
  ...
  // Make the folder open by default
  taskFolder.open();
